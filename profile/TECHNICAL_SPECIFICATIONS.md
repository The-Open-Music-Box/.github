# TheOpenMusicBox - Technical Specifications
...
graph TB
    ...
    subgraph CodeGen["⚙️ Code Generation (v3.3.1)"]
        OpenAPI --> Gen
        SocketIO --> Gen
        Gen[Generator]
    end
...
3. Commit versioned release (e.g., `releases/3.3.1/`)
...
#### I find a good dev board here:
[CardReader from Hermitx](https://learn.hermitx.es/product/CardReader)
...
mkdir -p releases/3.3.1
cp -r generated/{dart,cpp,python,typescript} releases/3.3.1/

# 4. Commit & tag
git add .
git commit -m "feat(contracts): bump to v3.3.1"
git tag v3.3.1
...
cd ..
git add contracts
git commit -m "chore: update contracts to v3.3.1"
...
| **Multi-Device Support** | N/A | N/A | ✅ | In Progress |
...
- **Contracts**: [contracts repository](https://github.com/The-Open-Music-Box/contracts)
- **RPI Backend**: [raspberrypi-firmware repository](https://github.com/The-Open-Music-Box/raspberrypi-firmware)
- **ESP32 Development**: Coming soon
